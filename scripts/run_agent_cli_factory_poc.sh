...
chmod +x "$WORK/scripts/scenarios/agent_cli_component_checks.sh" "$WORK/scripts/scenarios/agent_cli_user_scenarios.sh" "$WORK/scripts/scenarios/preflight_scenario.sh"
if [ -f "$ROOT/.env" ]; then
